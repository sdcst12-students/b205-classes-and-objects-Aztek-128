...
You should be able to set all of the important measurements (l,w,h) when the object is instantiated in the
constructor and you should have class methods that determine the surface area and volume.
...
class rectPrism:
    ...
    def __init__(self, l = 0, w = 0, h = 0):
        ...
        if h > 0:
            self.height = h
        # note you will need to specify more input 
        # parameters
        pass
